      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        ...
        >
          ...
          <div className="w-1/3 h-full min-h-0 flex flex-col shrink-0">
            {selectedDeck ? (
              <WSRReportPanel
                key={weekCardKey(selectedDeck)}
                startDate={selectedDeck.report_start_date}
                endDate={selectedDeck.report_end_date}
                variant={selectedDeck.variant ?? 1}
                mode="viewer"
                autoGenerate={false}
              ...
              <div className="flex flex-col items-center justify-center h-full text-center text-gray-400">
                <Presentation className="w-10 h-10 mb-3" />
                <p className="text-sm">Select a WSR deck to preview</p>
              </div>
            )}
          </div>
        </div>
