...
export function WSRReportPanel({
  ...
  return (
    <div className="relative flex flex-col h-full min-h-0 bg-brand-cream">
      <div className="relative flex items-center justify-between gap-3 px-6 py-3 bg-white border-b border-gray-200 flex-shrink-0 overflow-visible">
        {activeVariant > 1 ? (
      ...
      {variantNotice ? (
        <FloatingNotice
          ...
          tone="info"
          className="absolute top-4 left-1/2 z-20 w-[min(calc(100%-3rem),32rem)] -translate-x-1/2 text-xs shadow-lg"
        />
      ) : null}
